    ...
    <div class="flex-1 flex flex-col min-h-screen relative z-10">
      ...
      <div class="p-md md:p-lg flex-1 flex flex-col gap-lg max-w-container-max mx-auto w-full">
        <div class="animate-entrance">
          <h2 class="font-display-lg text-display-lg text-on-surface mb-xs">Repository Sync</h2>
          <p class="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">Connect your GitHub account to automatically generate portfolio items from your repositories.</p>
        </div>

        <div class="glass-panel border border-outline-variant/50 animate-entrance delay-100 p-12 text-center rounded-xl">
          ...
          <p class="font-body-md text-body-md text-on-surface-variant max-w-md mx-auto mb-8">Authorize DevPortfolio AI to read your repositories and commit history to automatically generate your showcase.</p>
          <button class="bg-primary hover:bg-primary/90 text-on-primary font-label-md text-label-md px-6 py-3 rounded-lg transition-colors shadow-lg shadow-primary/20 flex items-center justify-center gap-2 mx-auto pulse-amber">
